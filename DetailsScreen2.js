...
import wman from "./assets/wman.jpg";
  ...
  return (
    <View>
      ...
      <View style={styles.profilecontainer}>
        <Image source={wman} style={styles.image} />
        <View style={styles.info}>
          <Text style={styles.name}>Pokuah 101</Text>
          <Text style={styles.gen}>Radio/TV host</Text>
        </View>
      </View>
      ...
      <View style={styles.details}>
        ...
        <View style={styles.detailsicons}>
          ...
          <Text style={styles.news}>pokuah@gidiwebsolutions.com</Text>
        </View>
        <View style={styles.detailsicons}>
